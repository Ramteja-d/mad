...
import com.example.ecowalk.ui.settings.SettingsScreen
        ...
        if (loggedInUser == null) {
            ...
            Scaffold(
                bottomBar = {
                    ...
                    if (currentRoute in listOf(BottomNavItem.Home.route, BottomNavItem.GreenWalk.route, BottomNavItem.Profile.route)) {
                        NavigationBar {
                            val items = listOf(
                                BottomNavItem.Home,
